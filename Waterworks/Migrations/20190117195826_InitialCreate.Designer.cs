...
namespace Waterworks.Migrations
{
    ...
    [Migration("20190117195826_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Waterworks.Models.Db.Waterworks.FormulyZmniejszajace", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id");
                    ...
                    b.Property<int>("WodomierzId")
                        .HasColumnName("wodomierz_id");

                    b.HasKey("Id");

                    b.HasIndex("WodomierzId");

                    b.ToTable("formuly_zmniejszajace");
                });
            ...
            modelBuilder.Entity("Waterworks.Models.Db.Waterworks.Obiekt", b =>
                {
                    ...
                    b.Property<bool?>("AbonamentScieki")
                        .HasColumnName("abonament_woda");

                    b.Property<bool?>("AbonamentWoda")
                        .HasColumnName("abonament_scieki");
                    ...
                    b.Property<bool?>("Scieki")
                        .HasColumnName("scieki");
            ...
            modelBuilder.Entity("Waterworks.Models.Db.Waterworks.Wodomierz", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnName("id");

                    b.Property<DateTime>("DataEwidencji")
                        .HasColumnName("data_ewidencji")
                        .HasColumnType("date");

                    b.Property<DateTime>("DataLegalizacji")
                        .HasColumnName("data_legalizacji")
                        .HasColumnType("date");

                    b.Property<int>("NrWodomierza")
                        .HasColumnName("nr_wodomierza");

                    b.Property<int>("ObiektId")
                        .HasColumnName("obiekt_id");

                    b.Property<string>("TypWodomierza")
                        .IsRequired()
            ...
            modelBuilder.Entity("Waterworks.Models.View.Client.BasicCreateObjectViewModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("BasicCreateObjectViewModel");
                });

            modelBuilder.Entity("Waterworks.Models.View.Object.ObjectInListViewModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("ObjectInListViewModel");
                });

            modelBuilder.Entity("Waterworks.Models.View.PriceList.PriceViewModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("RodzajKlienta");
                    ...
                    b.ToTable("PriceViewModel");
                });

            modelBuilder.Entity("Waterworks.Models.View.PriceList.SubscriptionPriceViewModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("SubscriptionPriceViewModel");
                });
            ...
            modelBuilder.Entity("Waterworks.Models.Db.Waterworks.FormulyZmniejszajace", b =>
                {
                    b.HasOne("Waterworks.Models.Db.Waterworks.Wodomierz", "Wodomierz")
                        .WithMany("FormulyZmniejszajace")
                        .HasForeignKey("WodomierzId")
